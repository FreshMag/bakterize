 ...
 *
 *  This file is part of Bakterize, and is distributed under the terms of the Apache License 2.0, as described in the
...
val generatedFilesPackage = "io.github.bakterize.parsers.generated"
...
publishing {
    repositories {
        maven {
            name = "githubPackages"
            url = uri("https://maven.pkg.github.com/FreshMag/bakterize")
...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/FreshMag/bakterize")
